...
#define TSK_ACTIVE_MM 1320 /* offsetof(struct task_struct, active_mm) */
...
#define TI_CPU_EXCP 40 /* offsetof(struct thread_info, cpu_excp) */
#define TI_REGS_ON_EXCP 32 /* offsetof(struct thread_info, regs_on_excp) */
